...
function InlineLink(emailParameters: any = {}) {
  ...
  function renderEmail(emailComponent) {
    ...
    return `${doctype}${_server2.default.renderToStaticMarkup(emailComponent).replaceAll('/img/', 'https://indumentariacoqueta_.aptugo.com/img/')}`
  }
